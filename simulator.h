...
#define MAX_TAXIS              99   // Maximum number of Taxis in the system
#define MAX_REQUESTS           99   // Maximum number of customer requests at any time
...
const short AREA_X_LOCATIONS[6] = {380, 670, 650, 260, 350,  50};
const short AREA_Y_LOCATIONS[6] = { 80, 150, 530, 520, 300, 240};
